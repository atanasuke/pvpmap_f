...
execute as @e[type=armor_stand,name=thunder_area_c] at @s run scoreboard players add @a[y=~-1000,r=5.4] eshock 2
...
#recharge
execute as @a[scores={thunder_crash_recharge=..500,kit=24}] at @s unless entity @s[hasitem={item=pvpmap:thunder_crash_item,quantity=4..}] run scoreboard players add @s thunder_crash_recharge 1
execute as @a[scores={thunder_crash_recharge=500..,kit=24}] at @s unless entity @s[hasitem={item=pvpmap:thunder_crash_item,quantity=4..}] run give @s pvpmap:thunder_crash_item 1 
