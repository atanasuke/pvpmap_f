...
execute as @a[tag=thunder_shirld] at @s run scoreboard players remove @s elect 100
...
execute as @a[tag=thunder_shirld] at @s as @e[y=~1000r=4,tag=!thunder_shirld,family=inanimate] run tp @s ~~~ ~90~
