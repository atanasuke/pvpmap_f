...
execute as @e[type=armor_stand,tag=thunder_area_c,scores={thunder_time=200..}] at @s run particle ~~~ pvpmap:thunder_burst
execute as @e[type=armor_stand,tag=thunder_area_c,scores={thunder_time=200..}] at @s run playsound ambient.weather.thunder @a ~~~ 1 1 1
execute as @e[type=armor_stand,tag=thunder_area_c,scores={thunder_time=200..}] at @s run damage @e[y=~-999,r=5.2] 12 lightning entity @s
execute as @e[type=armor_stand,tag=thunder_area_c,scores={thunder_time=200..}] at @s run scoreboard players add @a[y=~-999,r=5.2] ieshock 30
kill @e[type=armor_stand,tag=thunder_area_c,scores={thunder_time=200..}]
